...
public class ActionButtonScript : MonoBehaviour {
	...
	void Update () {
		Ray ray = this.GetComponentInChildren<Camera>().ScreenPointToRay (new Vector3 (Screen.width * 0.5f, Screen.height * 0.5f, 0.0f)); //Declare a ray pointing out from the center of the camera view
